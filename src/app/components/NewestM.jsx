...
const NewestM = () => {
    ...
    const slideLeft = () => {
        ...
        sliderM.scrollLeft = sliderM.scrollLeft - 215
    }
        ...
        <>
            <div className='mt-[21px] shadow-[0_5px_8px_-3px_rgba(166,196,198.35)] rounded-[10px] relative'>
                <div className='flex p-[20px] justify-between'>
                    ...
                    <div>
                        <Link className='text-[#25ac9e]  p-[15px] text-[14px] ' href="/">مشاهده همه
                            <FontAwesomeIcon className='mr-[14px] size-[14px]  text-[#4b987f]' icon={faAngleLeft} />
                        </Link>
                    </div>
                </div>
                <div id='sliderM' className='overflow-x-scroll overflow-y-hidden no-scrollbar lg:overflow-x-clip flex'>
                    ...
                    <div className='pt-[15px] pb-[15px] '>
                        <div className='overflow-hidden w-64 lg:w-60 
                            ...
                            '>
                            <Link className='flex mb-[25px] justify-between' href="/">
                                <Image className='w-auto ' src={Cpu} />
                            </Link>
                            <div>
                                <Link href="/">
                                    <p className='flex text-center mb-[10px]'>پردازنده بدون باکس اینتل Core i3-14100F Raptor Lake</p>
                                </Link>
                                <div className='flex'>
                                    ...
                                    <div className='items-center flex pr-[15px] pl-[15px] '>
                                        <strong className='text-[#25ac9e]'>7,189,000 تومان</strong>
                                    </div>
                                </div>
                            </div>
                        </div>
